...
public record RollingPolicyOptions
{
    ...
    // public bool KeepStaticLogFile { get; set; } = false;
    
    /// <summary>
    /// The format of the rolled log file name.
    /// Default: "{0:yyyy-MM-dd-HH-mm-ss}_{1}{2}"
    /// </summary>
    public string RollingFileNameFormat { get; set; } = "{0:yyyy-MM-dd-HH-mm-ss}_{1}{2}";
}